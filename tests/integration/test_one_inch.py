...
def test_one_inch(mainnet_fork_web3, weiroll_vm):
    ...
    try:
        ...
        crv_address = Web3.to_checksum_address("0xD533a949740bb3306d119CC777fa900bA034cd52")
        ...
        one_inch_abi = [{"inputs":[], "name":"execute", "outputs":[], "stateMutability":"payable", "type":"function"}]
