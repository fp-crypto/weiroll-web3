...
def test_curve_add_liquidity(weiroll_vm, mainnet_fork_web3, setup_accounts, whale_account, token_dai, curve_pool, three_crv):
    # Use whale account
    whale = whale_account
    dev = setup_accounts
...
def test_curve_add_liquidity_with_call(weiroll_vm, mainnet_fork_web3, setup_accounts, whale_account, token_dai, curve_pool, three_crv):
    # Use whale account
    whale = whale_account
    dev = setup_accounts
