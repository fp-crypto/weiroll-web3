...
class SimpleWeirollContract:
    ...
    def _process_functions(self):
        ...
        function_names = [
            fn
            for fn in dir(self.web3_contract.functions)
    ...
    def _add_function(self, name, function):
        ...
        def wrapper(*args):
            ...
            return {"name": name, "args": args, "function": function}
...
if __name__ == "__main__":
    ...
    print(
        "Wrapped contract methods:", [m for m in dir(wrapped) if not m.startswith("_")]
    )
